...
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Detail Iklan <a href="tambahiklanstep1.php"><button type="button" class="btn btn-lg btn-primary"><i class="fa fa-plus"></i> &nbsp;&nbsp;Tambah Data Iklan</button></a></h1>
			</div>
		</div><!--/.row-->
